...
전력빅데이터기반융합SW개발자1기
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="700" height="80" role="img" aria-label="전력빅데이터기반융합SW개발자1기">
    <title>전력빅데이터기반융합SW개발자1기</title>
    <rect width="700" height="80" fill="#0064ff"/>
    <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif" text-rendering="geometricPrecision" font-size="24">
        <image x="10" y="20" width="40" height="40" xlink:href="data:image/png;base64,{base64_encoded_logo_image}"/>
        <text x="300" y="55" textLength="380" fill="#fff" font-weight="bold">전력빅데이터기반융합SW개발자1기</text>
    </g>
</svg>
